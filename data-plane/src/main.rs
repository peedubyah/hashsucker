// HashSucker south data plane -- production multi-TorrentFile binary.
//
...
impl ServiceState {
    ...
    async fn manager_for(
        self: &Arc<Self>,
        tf_id: &str,
        control: &data_plane::control::ControlResponse,
...
async fn handle_files(
    ...
    .await
    {
        ...
        Err(msg) => {
            ...
            // candidates. See docs/S1-CONTROL-CONTRACT.md (byte error contract).
    ...
    let state = Arc::new(AppState {
        ...
        // docs/CROSS-FILE-KEYING-AUDIT.md (P3 correction).
...
async fn handle_prewarm(
    ...
    let result = data_plane::serve::prewarm_placement(
        &svc.client,
        &svc.cfg.control_url,
        &keys,
        &svc.metrics,
