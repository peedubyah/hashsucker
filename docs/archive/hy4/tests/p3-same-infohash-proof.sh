...
# data-plane/src/cache.rs. The test is the 18th test in the
...
echo "  proof target  = data-plane/src/cache.rs (test #18 in cache::tests)"
echo ""
...
echo "[3/3] see data-plane/src/cache.rs for the test body"
exit $status
