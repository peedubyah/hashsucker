...
> **ARCHIVED PRE-CONSOLIDATION ARCHITECTURE:** Non-authoritative. The source of truth is [`../architecture.md`](../architecture.md); this snapshot overstates several implemented behaviors.

Historical text described this as the source-of-truth architecture document.
