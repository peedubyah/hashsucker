...
> **ARCHIVED PRE-CONSOLIDATION GAP LIST:** Non-authoritative and incomplete. Use [`../known-gaps.md`](../known-gaps.md) and [`../roadmap.md`](../roadmap.md).

Unresolved work items as documented before consolidation on 2026-08-21.
