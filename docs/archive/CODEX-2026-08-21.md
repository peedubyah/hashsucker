...
> **ARCHIVED IMPLEMENTATION DIARY:** Non-authoritative. Durable safety invariants were consolidated into [`../../HANDOFF.md`](../../HANDOFF.md); current code wins over this historical snapshot.
