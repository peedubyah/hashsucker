# HY4 Transplant Production Handoff (T1–T22)

**Branch:** `hy4-transplant` (20 commits, `46bde71..04d2458`, plus this handoff)
**Verdict:** production candidate is self-contained; `m3-north-db` is no
...
Tip `04d2458` was verified by the T21 integration gate (86 Rust lib tests,
...
`docs/hy4/S1-CONTROL-CONTRACT.md`). Node answers; Rust consumes.
...
- `hy4-data-plane/src/serve.rs`: `retired_side()` (used only by unit
