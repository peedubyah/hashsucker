...
CREATE TABLE requests (request_id TEXT PRIMARY KEY, state TEXT, media_type TEXT, scope TEXT, media_id TEXT, torbox_id INTEGER, info_hash TEXT, last_error TEXT, updated_at TEXT);
...
INSERT INTO requests VALUES ('movie-request', 'processing', 'movie', 'movie', 'tmdb:123', 30, '0123456789abcdef0123456789abcdef01234567', NULL, NULL);
INSERT INTO requests VALUES ('season-request', 'processing', 'tv', 'season', 'tt1', NULL, NULL, NULL, NULL);
...
INSERT INTO requests VALUES ('wrong-movie', 'processing', 'movie', 'movie', 'tmdb:999', 31, '0123456789abcdef0123456789abcdef01234568', NULL, NULL);
INSERT INTO requests VALUES ('imdb-movie', 'processing', 'movie', 'movie', 'tt0123456', 30, '0123456789abcdef0123456789abcdef01234567', NULL, NULL);
...
INSERT INTO requests VALUES ('processor-crash', 'processing', 'movie', 'movie', 'tmdb:123', 32, '0123456789abcdef0123456789abcdef01234569', NULL, NULL);
SQL
