...
const record = makeRecord({
  ...
  status: blocked ? 'BLOCKED' : tierOneRun ? (passed ? 'PASS' : 'FAIL') : 'SKIPPED',
  ...
  notes: [command === 'inspect' ? 'inspection only' : blocked ? 'dry run did not send a media request' : tierOneRun ? 'deterministic Tier 1 command executed' : 'runner execution intentionally deferred'],
});
